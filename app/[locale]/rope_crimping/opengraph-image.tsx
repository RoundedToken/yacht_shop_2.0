        ...
        (
            ...
            >
                ...
                <div style={{ display: 'flex', gap: 40, alignItems: 'center' }}>
                    <img
                        src={`${process.env.URL}/_next/image?url=%2Fassets%2Fimages%2FcrimpingImg.webp&w=750h=750&q=75`}
                    ...
                    <div style={{ textShadow: '2px 2px 2px rgba(2, 40, 163, 0.782)' }}>{t('rope_crimping')}</div>
                </div>
            </div>
        ),
